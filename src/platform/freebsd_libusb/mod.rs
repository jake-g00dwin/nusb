...
mod hotplug;
pub(crate) use hotplug::FreeBSDHotplugWatch as HotplugWatch;
mod events;

mod device;
pub(crate) use device::FreeBSDDevice as Device;
pub(crate) use device::FreeBSDEndpoint as Endpoint;
pub(crate) use device::FreeBSDInterface as Interface;
